...
lyr_Sekolah_2.set('fieldAliases', { 'Sekolah': 'Sekolah', 'NPSN': 'NPSN', 'Jenjang': 'Jenjang', 'Status': 'Status', 'Alamat': 'Alamat', 'Kalurahan': 'Kalurahan', 'Kapanewon': 'Kapanewon', 'SPPG': 'SPPG', 'Siswa': 'Siswa', 'Guru': 'Guru', 'Total': 'Total', 'No': 'No', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Easting': 'Easting', 'Northing': 'Northing', 'Radius': 'Radius', 'Layout': 'Layout', });
...
lyr_SPPG_5.set('fieldAliases', { 'SPPG': 'SPPG', 'Alamat': 'Alamat', 'Kalurahan': 'Kalurahan', 'GoogleMaps': 'GoogleMaps', 'Porsi': 'Porsi', 'ID': 'ID', 'Easting': 'Easting', 'Northing': 'Northing', 'Latitude': 'Latitude', 'Longitude': 'Longitude', });
...
lyr_SPPG_5.set('fieldImages', { 'SPPG': 'TextEdit', 'Alamat': 'TextEdit', 'Kalurahan': 'TextEdit', 'GoogleMaps': 'TextEdit', 'Porsi': 'TextEdit', 'ID': 'TextEdit', 'Easting': 'TextEdit', 'Northing': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', });
